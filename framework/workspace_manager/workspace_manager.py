...
@dataclass
class SpiritWorkspaceManager:
    """Manage branch naming and commit formatting for spirit workspaces.
    
    This class provides utilities for spirit agents to create properly formatted
    branch names and commit messages following the Spirit Protocol.
    """
    ...
    def format_commit_message(
        ...
        """Return commit messages matching Spirit Protocol format.
...
class WorkspaceOrchestrator:
    ...
    WorkspaceOrchestrator handles the creation, retrieval, listing, and cleanup
    of isolated workspace directories for spec task execution. Each workspace
    contains a cloned repository and maintains its own git state.
    """
    
    def __init__(self, config: WorkspaceConfig):
        """Initialize WorkspaceOrchestrator with configuration.
