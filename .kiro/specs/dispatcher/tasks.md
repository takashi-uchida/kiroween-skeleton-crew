...
- [x] 5. AgentPoolManagerの実装
  - [x] 5.1 Agent Pool設定の読み込み
...
- [x] 6. RunnerLauncherの実装
  ...
  - [x] 6.2 Local Process Launcher
    - LocalProcessLauncherクラス: ローカルプロセスとして起動
    - サブプロセスの管理
    - _Requirements: 5.1_

  - [x] 6.3 Docker Launcher
