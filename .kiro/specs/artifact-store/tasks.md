...
- [x] 13. エラーハンドリングとリトライの実装
  - [x] 13.1 ネットワークエラーのリトライ
    - ネットワークエラーの検出
    - 3回までのリトライ
    - 指数バックオフ
