...
- [ ] 5. ArtifactUploaderの実装
  - [ ] 5.1 Artifact Storeクライアント
...
- [ ] 12. 実行環境の実装
  - [ ] 12.1 Local Process Mode
    - LocalProcessRunnerクラスの実装
    - ローカルプロセスとしての実行
    - _Requirements: 9.2_

  - [ ] 12.2 Docker Container Mode
    - DockerRunnerクラスの実装
    - Dockerコンテナとしての実行
    - ワークスペースのマウント
    - 環境変数の注入
